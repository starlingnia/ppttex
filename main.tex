...
\begin{columns}[T]
    \begin{column}{0.48\textwidth}
        \centering
        {\footnotesize Our Result ($N_f = 2+1$ Möbius DWF)} \\
        \vspace{0.2em}
    ...
    \begin{column}{0.48\textwidth}
        \centering
        {\footnotesize Previous Result ($N_f = 2$ DWF)} \\
        \vspace{0.2em}
...
\begin{columns}[c]
    ...
    \begin{column}{0.5\textwidth}
        \centering
        {\footnotesize Our $U(1)_A$ ($N_f = 2+1$ Möbius DWF)} \\
        \vspace{0.3em}
    ...
    \begin{column}{0.48\textwidth}
        \centering
        {\scriptsize Our Chiral ($N_f = 2+1$ Möbius DWF)} \\
        \vspace{0.1em}
        \includegraphics[width=0.52\textwidth]{symmetry_breaking_Chiral_AV_Vec.pdf} \\
        \vspace{0.5em}
        {\scriptsize Previous $U(1)_A$ ($N_f = 2$ DWF)} \\
        \vspace{0.1em}
